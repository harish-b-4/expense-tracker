...
function AddTransaction({ addNewTransactions }) {
      ...
      <div className="w-full max-w-2xl bg-white rounded-3xl shadow-xl p-6 sm:p-8 md:p-10">
        ...
        <form onSubmit={handleSubmit} className="space-y-5 sm:space-y-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 pt-3 sm:pt-4">
            ...
            <button
              type="submit"
              className="flex-1 bg-indigo-600 text-white py-2.5 sm:py-3 rounded-xl font-semibold shadow-lg hover:bg-indigo-700 hover:scale-[1.02] transition-all duration-300 text-sm sm:text-base cursor-pointer"
            >
              Add Transaction
            </button>
